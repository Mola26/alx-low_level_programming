...
/**
 * check_elf - display infomation in ELF header
 * @e_ident: A pointer
 *
...
/**
 * print_magic - Prints the magic num
 * @e_ident: the pointer to an array
 *
 * Description: Magic num are separated
 */
void print_magic(unsigned char *e_ident)
{
	int index;
...
/**
 * main - the information contained in the ELF header
